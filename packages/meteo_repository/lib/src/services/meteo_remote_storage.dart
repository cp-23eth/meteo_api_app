...
class MeteoRemoteStorage implements MeteoStorage {
  static const url = 'https://api.open-meteo.com/v1/forecast?latitude=47.16,47.18,47.12&longitude=7.02,6.9,7.2599998&current=temperature_2m,relative_humidity_2m,is_day,precipitation,rain,snowfall,weather_code,wind_speed_10m&daily=temperature_2m_max,temperature_2m_min&timezone=Europe%2FBerlin&forecast_days=1';
